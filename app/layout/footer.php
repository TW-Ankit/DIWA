    ...
    <div class="container">
        <footer class="text-center">
            <div class="btn-group large">
                ...
                <a href="https://github.com/" target="_blank" class="btn btn-default" data-toggle="tooltip" title="DIWA's GitHub Repository"><i class="fa fa-github" aria-hidden="true"></i></a>
                <a href="https://github.com/" target="_blank" class="btn btn-default" data-toggle="tooltip" title="Report a Bug or suggest an Improvement"><i class="fa fa-bug" aria-hidden="true"></i></a>
            </div>
        </footer>
    </div>
<?php } ?>
